...
ggsave('PCA Biplot_mean_positions_uninf.png', pca_plot2,width =10, height=6)   
```
...
ggsave('PCA Biplot_mean_positions_inf.png', pca_plot2,width =10, height=6)   
```
...
## Linear Models
Fit linear models for each vaccine to assess the effect of sex on the immune response profile for infected individuals:
