...
#extract p-values
p_values <- c(
  summary(beta_uninfected)$coefficients$mu[, "Pr(>|z|)"],
  summary(beta_uninfected)$coefficients$phi[, "Pr(>|z|)"],
  summary(beta_uninfected)$coefficients$nu[, "Pr(>|z|)"]
)
p_values
...
#Extract p-values
p_values <- c(
  summary(beta_infected)$coefficients$mu[, "Pr(>|z|)"],
  summary(beta_infected)$coefficients$phi[, "Pr(>|z|)"],
  summary(beta_infected)$coefficients$nu[, "Pr(>|z|)"]
)
p_values
...
p_vec <- c(
  summary(beta_h1_inf)$coefficients$mean[2, 4],
  summary(beta_h56_inf)$coefficients$mean[2, 4],
...
# Wald test
Wald_inf <- car::linearHypothesis(full_model_inf, c("sexmale = 0", "sexmale:vaccineh1 = 0","sexmale:vaccineh56 = 0", "sexmale:vaccinemva85a = 0"))
